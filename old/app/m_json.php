...
if ($_GET['mode']=='models'){
  if (ereg ("307 Temporary Redirect", $html_result, $regs)) 
  {
    $html_result = http_load( "http://automixs.com/manheim/give.php?mode=".$_GET['mode']."&nom=".$_GET['make'], "https://www.manheim.com/members/powersearch/", $_COOKIE, $manheim_login, $post, null, null, null, 0 );
  } 
