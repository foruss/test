...
echo('<div align="right"><a class="spec_n" href="app/news/new.html">+ Add News</a></div>');
if ($msg == 'ok') {
...
echo('<tr>
		<td height="23" bgcolor="#f5f5f5" align="center" width="400">Page</td>
...
echo('<tr onmouseover="style.backgroundColor=\'#f8f8f8\'" onmouseout="style.backgroundColor=\'\';">
		...
		<td height="22" style="font-size: 8.5pt"><a href="?psl=app&do=news&step=edit&id='.$id.'">Edit</a> | <a onClick="if(confirm(\'Are you sure you want to delete this page?\r\n The page will be deleted permanently\')); else return false;" href="?psl=app&do=news&step=delete&id='.$id.'">Delete</a></td>
	</tr>');
}
echo('</table></div>');
} else if ($step == 'new') {
...
echo('<h1>Add News</h1><form name="tform" method="post" action="" enctype="multipart/form-data"><div align="center"><table border="0" width="700" id="table1" style="border-collapse: collapse" cellpadding="0">
	<tr>
		<td width="150" style="text-indent: 5px" bgcolor="#F9F9F9" height="25">Headline:</td>
	...
	<tr>
		...
		<td width="150" style="text-indent: 5px" height="25">Language:</td>
		<td width="550" height="25"><select size="1" name="lang" style="width: 95%"><option selected value="ru">RU</option></select></td>
	</tr><tr>
		<td width="150" style="text-indent: 5px" bgcolor="#F9F9F9" height="25">Date:</td>
...
<textarea name="FCKeditor1" id="FCKeditor1"  style="background: #FFFFFF; width: 95%; height:450; padding: 5px"></textarea>
	...
	<tr>
		<td colspan="2" width="700" height="35"><input type="submit" class="button" name="submit" onclick="if(tfrom.url.value=='') my_url(); else tform.submit();" value="Submit News"></td>
	</tr>
</table></form></div> <?php 
...
$url = $otz['url'];
echo('<h1>Edit News</h1><form name="tform" method="post" action="?psl=app&do=news&step=edit&id='.$id.'" enctype="multipart/form-data"><div align="center"><table border="0" width="700" id="table1" style="border-collapse: collapse" cellpadding="0">
	<tr>
		<td width="150" style="text-indent: 5px" bgcolor="#F9F9F9" height="25">Headline:</td>
