...
$email2 = processPostVariable('email_2');
 ...
 if ($send) {
	...
	$subject = "$name предлагает посмотреть инфо об авто"; //чего пишем в заголовке
	//само письмо
	$message_text = ""; 
	$message_text.= "$name предлагает посмотреть инфо об авто:<br>";
	$message_text.= "<a href=http://automixs.com/auto/show/$send/>Авто</a>";
