...
$email2 = processPostVariable('email_2');
 ...
 if ($send) {
	...
	$machinery=getAllMachinerybyID1($send);
	$message_text.= "Марка: ".$machinery['mark']."<br>";
	$message_text.= "Модель: ".$machinery['model']."<br>";
	$message_text.= "Год: ".$machinery['year']."<br>";
	$message_text.= "Тип: ".$machinery['tip']."<br>";
	$message_text.= "Двигатель: ".$machinery['dvig']."<br>";
	$message_text.= "Цена: ".$machinery['cost']."<br>";
	$message_text.= "<img src=automixs.com/planeimg/".$machinery['pic1']."><br>";
