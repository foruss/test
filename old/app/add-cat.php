...
echo('<div align="center"><div style="margin: 10px 0; border: 1px dashed #999999; background: #FFFFFF; line-height: 150%; padding: 5px 10px; color: #990000; text-align: center; width: 250px">Pаздел успешно удален!</div></div>');
} else if ($msg == 'updated') {
...
echo('<div align="center" style="margin: 10px 0 0 0"><a href="?psl=app&do=categories&step=new">Добавить раздел</a><br><table border="1" width="500" cellspacing="0" cellpadding="0" style="border-collapse: collapse; margin: 10px 0 0 0" bordercolor="#E1E1E1">');
echo('<tr>
		<td height="23" bgcolor="#f5f5f5" align="center" width="100">Изображение</td>
		<td height="23" bgcolor="#f5f5f5" align="center" width="180">Название</td>
		<td height="23" bgcolor="#f5f5f5" align="center" width="220">Управление</td>
	</tr>');
...
$img = $gz['img'];
if ($on == '1') {
$onf ='<a href="?psl=app&do=categories&step=ch&w=0&id='.$id.'">Выключить</a>';
} else if ($on == '0') {
$onf ='<a href="?psl=app&do=categories&step=ch&w=1&id='.$id.'">Включить</a>';
}
echo('<tr onmouseover="style.backgroundColor=\'#F8F8F8\'" onmouseout="style.backgroundColor=\'\';">
		...
		<td height="23" align="center" width="220" style="font-size: 8pt"><a href="?psl=app&do=categories&step=edit&id='.$id.'">Редактировать</a> | <a onClick="if(confirm(\'Вы уверены, что хотите удалить этoт раздел?\')); else return false;" href="?psl=app&do=categories&step=delete&id='.$id.'">Удалить</a> | '.$onf.'</td>
	</tr>');
...
$im = '<img src="'.$img.'" style="margin: 0 5px 0 0"><a onClick="if(confirm(\'Вы уверены, что хотите удалить этот иконка?\')); else return false;" href="?psl=app&do=categories&step=del_img&id='.$id.'">Удалить фото</a><input type="hidden" name="baneris" value="'.$img.'">';
}
$link = $zii['url'];
echo('<div align="center">
