...
$ffoto=mysql_query("Select * from `foto` where `sid`='$id' and `type`='5' order by `id` asc LIMIT 0,1");
...
$gff=mysql_query("Select * from `foto` where `sid`='$id' and `type`='5' order by `id` asc");
$i = 1;
							...
							<table cellpadding="0" cellspacing="0" border="0">
								...
								<tr class="gr">
								  ...
								  <td><div><?php echo $title; ?></div></td>
									...
									<td><strong>Трансмисия:</strong></td>
...
$buk = '<div style="padding: 2px; margin: 0 0 0 2px; height: 20; background: #FF9900; text-align: center; color: #FFFFFF">Плохое</div>';
	...
	?>
				...
				<?php 
				$id = $otas['id'];
				$updazz=mysql_query("Update `spec` set `viewed`=viewed+1 where `id`='$id'");
}
