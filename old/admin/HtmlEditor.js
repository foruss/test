...
Ext.form.HtmlEditor = Ext.extend(Ext.form.Field, {
     ...
     */
    createLinkText : 'Пожалуйста введите URL для ссылки:',
    /**
    ...
    createToolbar : function(editor){
        ...
        if(!Ext.isSafari){
			...
			if(this.enableImages){
				tb.add(
					'-',
					btn('insertimage', false, this.insertImage),
					btn('insertimageleft', false, this.insertImageLeft),
					btn('insertimageright', false, this.insertImageRight)
				);
			};
            if(this.enableLists){
                tb.add(
    ...
    insertImage : function(){
        var url = prompt('Введите url для картинки', '/img/');
        if(url && url != 'http:/'+'/'){
            this.relayCmd('insertimage', url);
            //this.relayCmd('inserthtml', '<img src="' + url + '" style="float: left;" />');
        }
    },
    insertImageLeft : function(){
        var url = prompt('Введите url для картинки', '/img/');
        if(url && url != 'http:/'+'/'){
            //this.relayCmd('insertimage', url);
            this.relayCmd('inserthtml', '<img src="' + url + '" style="float: left;" />');
    ...
    insertImageRight : function(){
        var url = prompt('Введите url для картинки', '/img/');
        if(url && url != 'http:/'+'/'){
            //this.relayCmd('insertimage', url);
            this.relayCmd('inserthtml', '<img src="' + url + '" style="float: right;" />');
        }
    },
    ...
    * @type Object
    ...
    buttonTips : {
        ...
        insertimage : {
            ...
            text: 'Вставляет картинку на место курсора.',
            cls: 'x-html-editor-tip'
        },
        insertimageleft : {
            title: 'Вставить картинку слева',
            text: 'Вставляет картинку с обтеканием слева.',
            cls: 'x-html-editor-tip'
        },
        insertimageright : {
            title: 'Вставить картинку справа',
            text: 'Вставляет картинку с обтеканием справа.',
            cls: 'x-html-editor-tip'
        }
