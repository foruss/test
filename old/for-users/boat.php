...
echo('<form method="POST" style="margin: 0; padding: 0" action="loged/boat.html"><div style="margin: 0 0 10px 0; padding: 0 0 5px 0; border-bottom: 1px solid #e1e1e1">Search by Lot# <input type="text" style="width: 50px" name="lot"><input type="submit" name="submit" value="OK" style="margin: 0 5px 0 5px"></div></form>');
...
$get_autos=mysql_query("Select * from `valtis` where ".$ka." order by `id` desc");
...
echo('<tr onmouseover="style.backgroundColor=\'#f8f8f8\'" onmouseout="style.backgroundColor=\'\'">
		...
		<td height="22" style="border-bottom: 1px solid #e1e1e1; text-align: left">&nbsp;<a target=_blank title="'.$marke.' '.$modelis.', '.$metai.' г. - '.$kaina.' '.$kt.'" href="boat/show/'.$id.'/"><b>'.$marke.' '.$modelis.'</b>, '.$metai.' г. - '.$kaina.' '.$kt.'</a> '.$sold.'</td>
		...
		<td height="22" width="170" align="center" style="font-size: 8pt; border-bottom: 1px solid #e1e1e1"><a href="?psl=loged&do=boat&step=edit&id='.$id.'">Edit</a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onClick="if(confirm(\'Are you sure you want to remove this Boat?\')); else return false;" href="?psl=loged&do=boat&step=delete&id='.$id.'">Delete</a></td>
	</tr>');
}
echo('</table></div>');

echo('<div style="margin: 10px 0 0 30px"><input type="button" value="Select All" onclick="checkAll()"> <input type="button" value="Delete Selected Boats" onclick="if (confirm(\'Are you sure you want to remove?\')) { f1.action=\'?psl=loged&do=boat&step=del_sel\'; f1.submit(); } else { }"> <input type="button" value="Mark as Sold" onclick="f1.action=\'?psl=loged&do=boat&step=sel_prod\'; f1.submit();"> <input type="button" value="Unmark as Sold" onclick="f1.action=\'?psl=loged&do=boat&step=sel_nprod\'; f1.submit();"></div></form>');
$utype = $uss['type'];
$vipd = $uss['vip'];
$dabar = date("Y-m-d H:i:s");
if ($utype == 'f56e82798de1b89f7a4d77479ead7280' || $vipd >= $dabar) {
echo('<div style="margin: 10px 0 0 30px"><input type="button" value="Show on Main Page" onclick="f1.action=\'?psl=loged&do=boat&step=intop&w=1\'; f1.submit();"> <input type="button" value="Dont Show on Main Page" onclick="f1.action=\'?psl=loged&do=boat&step=intop&w=0\'; f1.submit();"></div>');
}
}else if ($step == 'add') {
?>
...
<?php
echo('<h1>Enter Boat Information</h1>');
echo('<form name="nskk" action="add_boat.php" method="post" enctype="multipart/form-data"><table border="0" width="400" cellpadding="0" style="border-collapse: collapse">
	<tr>
		<td height="22" width="140">Make:</td>
		<td><input type="text" name="gam" style="width: 200px"></td>
	</tr>
	<tr>
		<td height="22" width="140">Model:</td>
		<td><input type="text" name="pav" style="width: 200px"></td>
	</tr>
	<tr>
		<td height="22" width="150">Tipe:</td>
		<td><input type="text" name="tipas" style="width: 200px"></td>
	</tr>
	<tr>
		<td height="22" width="150">Category:</td>
		<td><select size="1" name="kat" style="width: 200px"><option value="0">Clean</option><option value="1">With Damage</option></select></td>
	</tr> 
	<tr><tr>
		<td height="22" width="150">Title:</td>
		<td><input type="text" name="title" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">VIN:</td>
		<td><input type="text" name="vin" style="width: 200px"><input type="hidden" name="uid" value="'.$uid.'"></td>
	</tr><tr>
		<td height="22" width="150">Year:</td>
		<td><select size="1" name="metai" style="width: 200px"><option value="">- Select -</option><option             value="2015">2015</option><option value="2014">2014</option><option value="2013">2013</option><option value="2012">2012</option><option value="2011">2011</option><option value="2010">2010</option><option value="2009">2009</option><option value="2008">2008</option><option value="2007">2007</option><option value="2006">2006</option><option value="2005">2005</option><option value="2004">2004</option><option value="2003">2003</option><option value="2002">2002</option><option value="2001">2001</option><option value="2000">2000</option><option value="1999">1999</option><option value="1998">1998</option><option value="1997">1997</option><option value="1996">1996</option><option value="1995">1995</option><option value="1994">1994</option><option value="1993">1993</option><option value="1992">1992</option><option value="1991">1991</option><option value="1990">1990</option><option value="1989">1989</option><option value="1988">1988</option><option value="1987">1987</option><option value="1986">1986</option><option value="1985">1985</option><option value="1984">1984</option><option value="1983">1983</option><option value="1982">1982</option><option value="1981">1981</option><option value="1980">1980</option><option value="1979">1979</option><option value="1978">1978</option><option value="1977">1977</option><option value="1976">1976</option><option value="1975">1975</option><option value="1974">1974</option><option value="1973">1973</option><option value="1972">1972</option><option value="1971">1971</option><option value="1970">1970</option><option value="1969">1969</option><option value="1968">1968</option><option value="1967">1967</option><option value="1966">1966</option><option value="1965">1965</option><option value="1964">1964</option><option value="1963">1963</option><option value="1962">1962</option><option value="1961">1961</option><option value="1960">1960</option><option value="1959">1959</option><option value="1958">1958</option><option value="1957">1957</option><option value="1956">1956</option><option value="1955">1955</option><option value="1954">1954</option><option value="1953">1953</option><option value="1952">1952</option><option value="1951">1951</option><option value="1950">1950</option><option value="1949">1949</option><option value="1948">1948</option><option value="1947">1947</option><option value="1946">1946</option><option value="1945">1945</option><option value="1944">1944</option><option value="1943">1943</option><option value="1942">1942</option><option value="1941">1941</option><option value="1940">1940</option><option value="1939">1939</option><option value="1938">1938</option><option value="1937">1937</option><option value="1936">1936</option><option value="1935">1935</option></select></td>
                ...
                <td height="22" width="150">Length(feet):</td>
		<td><input type="text" name="ilgis" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Width:</td>
		<td><input type="text" name="plotis" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Passengers:</td>
		<td><input type="text" name="vietos" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Fuel Tipe:</td>
		<td><input type="text" name="ksanaud" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Engine:</td>
		<td><input type="text" name="variklis" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Price:</td>
	...
	<tr>
		<td height="22" width="150">Location:</td>
...
echo('  <tr>
		<td height="22" width="150">Free Gift:</td>
		<td><input type="file" name="dovana" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Ссылка(for free):</td>
...
echo('<tr><td colspan="9" height="25"></td></tr><tr><td colspan="9" height="22"><b>Options:</b></td></tr><tr><td colspan="9"><textarea rows="5" name="options" style="width: 600px"></textarea></td></tr>');
...
$utype = $uss['type'];
if ($utype == 'f56e82798de1b89f7a4d77479ead7280') {
$get_inf=mysql_query("Select * from `valtis` where `id`='$id'");
} else {
$get_inf=mysql_query("Select * from `valtis` where `id`='$id' and `uid`='$uid'");
 }
...
$vietos = $otm['vietos'];
$ksanaud = $otm['ksanaud'];
$variklis = $otm['variklis'];
$kaina = $otm['kaina'];
$ktype = $otm['ktype'];
$akcija = $otm['akcija'];
$option = stripslashes($otm['option']);
...
$dovana = $otm['gift'];
if (empty($dovana)) { $dov ='<input type="file" name="dovana" style="width: 200px">'; } else { $dov ='<input type="hidden" name="gift" value="'.$dovana.'"><img src="phpThumb.php?src='.$dovana.'&w=120&h=100" align="left" style="margin: 0 10px 0 0"><a onClick="if(confirm(\'Are you sure you want to remove this Photo?\')); else return false;" href="?psl=loged&do=boat&step=del_photo&id='.$id.'">Delete Photo</a>'; }

echo('<h1>Edit Boat Information</h1>');
echo('<a href="?psl=loged&do=valtis&step=photo&id='.$id.'">Edit photo</a>');
echo('<form name="nskk" action="update_boat.php" method="post" enctype="multipart/form-data"><table border="0" width="400" cellpadding="0" style="border-collapse: collapse">
	<tr>
		<td height="22" width="140">Make:</td>
		<td><input type="text" name="gam" value="'.$gam.'" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="140">Model:</td>
	...
	<tr><tr>
		...
		<td height="22" width="150">Year:</td>
		<td><select size="1" name="metai" style="width: 200px"><option value="">- Select -</option><option selected value="2015">2015</option><option value="2014">2014</option><option value="2013">2013</option><option value="2012">2012</option><option value="2011">2011</option><option value="2010">2010</option><option value="2009">2009</option><option value="2008">2008</option><option value="2007">2007</option><option value="2006">2006</option><option value="2005">2005</option><option value="2004">2004</option><option value="2003">2003</option><option value="2002">2002</option><option value="2001">2001</option><option value="2000">2000</option><option value="1999">1999</option><option value="1998">1998</option><option value="1997">1997</option><option value="1996">1996</option><option value="1995">1995</option><option value="1994">1994</option><option value="1993">1993</option><option value="1992">1992</option><option value="1991">1991</option><option value="1990">1990</option><option value="1989">1989</option><option value="1988">1988</option><option value="1987">1987</option><option value="1986">1986</option><option value="1985">1985</option><option value="1984">1984</option><option value="1983">1983</option><option value="1982">1982</option><option value="1981">1981</option><option value="1980">1980</option><option value="1979">1979</option><option value="1978">1978</option><option value="1977">1977</option><option value="1976">1976</option><option value="1975">1975</option><option value="1974">1974</option><option value="1973">1973</option><option value="1972">1972</option><option value="1971">1971</option><option value="1970">1970</option><option value="1969">1969</option><option value="1968">1968</option><option value="1967">1967</option><option value="1966">1966</option><option value="1965">1965</option><option value="1964">1964</option><option value="1963">1963</option><option value="1962">1962</option><option value="1961">1961</option><option value="1960">1960</option><option value="1959">1959</option><option value="1958">1958</option><option value="1957">1957</option><option value="1956">1956</option><option value="1955">1955</option><option value="1954">1954</option><option value="1953">1953</option><option value="1952">1952</option><option value="1951">1951</option><option value="1950">1950</option><option value="1949">1949</option><option value="1948">1948</option><option value="1947">1947</option><option value="1946">1946</option><option value="1945">1945</option><option value="1944">1944</option><option value="1943">1943</option><option value="1942">1942</option><option value="1941">1941</option><option value="1940">1940</option><option value="1939">1939</option><option value="1938">1938</option><option value="1937">1937</option><option value="1936">1936</option><option value="1935">1935</option></select></td>
	</tr><tr>
		<td height="22" width="150">Length(feet):</td>
		<td><input type="text" name="ilgis" value="'.$ilgis.'" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Width:</td>
		<td><input type="text" name="plotis" value="'.$plotis.'" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Passengers:</td>
		<td><input type="text" name="vietos" value="'.$vietos.'" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Fuel Tipe:</td>
		<td><input type="text" name="ksanaud" value="'.$ksanaud.'" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Engine:</td>
		<td><input type="text" name="variklis" value="'.$variklis.'" style="width: 200px"></td>
	</tr><tr>
		<td height="22" width="150">Price:</td>
		<td><input type="text" name="kaina" value="'.$kaina.'" style="width: 150px"><select size="1" name="ktipas" style="width: 45px; margin: 0 0 0 5px"><option '); if ($ktypoe == '1') { echo " selected "; } else { } echo(' value="1">$</option><option '); if ($ktypoe == '2') { echo " selected "; } else { } echo(' value="2">€</option></select></td>
	</tr>
	<tr>
		<td height="22" width="150">Location:</td>
...
echo('<tr>
		<td height="22" width="150">Free Gift:</td>
		<td><input type="file" name="dovana" style="width: 200px">
	</tr><tr>
		<td height="22" width="150">URL(for free):</td>
...
echo('<table border="0" width="600" id="table1" cellpadding="0" style="border-collapse: collapse">');
echo('<tr><td colspan="9" height="25"></td></tr><tr><td colspan="9" height="22"><b>Options:</b></td></tr><tr><td colspan="9"><textarea rows="5" name="options" style="width: 600px">'.$option.'</textarea></td></tr>');
...
//echo('<tr><td colspan="9" height="35" align="center"><input type="button" value="Mark as Sold" onclick="location.href=\'step/change_it.php?point=3&sec=1&cid='.$id.'&uid='.$uid.'&back=edit\'"> <input type="button" value="Unmark as Sold" onclick="location.href=\'step/change_it.php?point=3&sec=0&cid='.$id.'&uid='.$uid.'&back=edit\'"> <input type="submit" value="Renew Add"></</td></tr>');
...
$id = $_GET['id'];
$geto=mysql_query("Select * from `valtis` where `id`='$id'");
$gzz=mysql_fetch_array($geto);
$gift = $gzz['gift'];
@unlink("$gift");
$delaz=mysql_query("Update `valtis` set `gift`='' where `id`='$id'");

echo('<script type="text/javascript">window.location = "?psl=loged&do=valtis&step=edit&id='.$id.'"</script>');
} else if ($step == 'photo') {
$sid = $_GET['id'];
echo('<h1>Edit/Delete Photo</h1>');
$get_fotos=mysql_query("Select * from `foto` where `type`='3' and `sid`='$sid' order by `id` asc");
while($ozz=mysql_fetch_array($get_fotos)) {
$id = $ozz['id'];
$url = $ozz['url'];
echo('<div style="float: left; background: #FFFFFF; padding: 3px; border: 1px solid #cccccc; text-align: center; height: 135px; margin: 0 4px 10px 4px; width: 134px"><span id="images"><a rel="group" target="_blank" class="images" href="phpThumb.php?src='.$url.'&w=800"><img src="phpThumb.php?src='.$url.'&w=134&h=108" style="margin: 0 0 3px 0; border: 0"></a></span><br><a onClick="if(confirm(\'Are you sure you want to remove this Photo?\')); else return false;" href="?psl=loged&do=valtis&step=df&sid='.$sid.'&fid='.$id.'">Delete</a></div>');
...
<form method="post" enctype="multipart/form-data" action="?psl=loged&do=boat&step=up_ff" name="sfoto"><input type="file" onchange="document.sfoto.submit()" name="foto" style="width:250px"><input type="hidden" name="sid" value="'.$sid.'"></form></div></div>');

echo('<div style="width: 100%; padding: 10px; border-top: 1px solid #cccccc"><a href="loged/boat.html">List of Boats</a> | <a href="/">Go to Main Page</a> | <a href="loged/boat/add.html">Add New Boat</a></div>');
} else if ($step == 'df') {
$sid = $_GET['sid'];
$fid = $_GET['fid'];
...
echo('<script type="text/javascript">window.location = "?psl=loged&do=boat&step=photo&id='.$sid.'"</script>');
} else if ($step == 'up_ff') {
$sid = $_POST['sid'];
...
$insas=mysql_query("Insert into `foto` set `url`='$file_destination', `sid`='$sid', `type`='3'");
} else {
...
$utype = $uss['type'];
if ($utype == 'f56e82798de1b89f7a4d77479ead7280') {
$get_zz=mysql_query("Select * from `valtis` where `id`='$id'");
} else {
$get_zz=mysql_query("Select * from `valtis` where `id`='$id' and `uid`='$uid'");
}
$skkz=mysql_num_rows($get_zz);
if ($get_zz =='1') {
$delf=mysql_query("Select * from `foto` where `type`='3' and `sid`='$id'");
while($fo=mysql_fetch_array($delf)) {
$url = $fo['url'];
@unlink("$url");
}
$delz=mysql_query("Delete from `foto` where `type`='3' and `sid`='$id'");
if ($utype == 'f56e82798de1b89f7a4d77479ead7280') {
$del_a=mysql_query("Delete from `valtis` where `id`='$id'");
} else {
$del_a=mysql_query("Delete from `valtis` where `id`='$id' and `uid`='$uid'");
}

}
echo('<script type="text/javascript">window.location = "?psl=loged&do=boat&msg=deleted"</script>');
...
$imk_mot=mysql_query("Select * from `foto` where `sid`='$value' and `type`='3'");
...
$del_ff=mysql_query("Delete from `foto` where `sid`='$value' and `type`='3'");
$del_mo=mysql_query("Delete from `valtis` where `id`='$value'");

}
}
echo('<script type="text/javascript">window.location = "?psl=loged&do=boat&msg=deleted2"</script>');
...
while(list($name, $value) = each($yp)) {
$dt = date("Y-m-d H:i:s");
$updazz=mysql_query("Update `valtis` set `parduota`='$dt' where `id`='$value'");
}
}
echo('<script type="text/javascript">window.location = "?psl=loged&do=boat&msg=prod"</script>');
...
$updazz=mysql_query("Update `valtis` set `parduota`='0' where `id`='$value'");
}
}
echo('<script type="text/javascript">window.location = "?psl=loged&do=boat&msg=nprod"</script>');
