<?php
	...
	if (empty($make)){
		...
		$url = 'https://www.iaai.com/CarsService.asmx/GetMakesByType';
		$post = '{"knownCategoryValues":"VehicleType:'.$vtypeid.';","category":"Make"}';
		$html_result = http_loadIAAI( $url,'https://www.iaai.com/Vehicles/VehicleSearch.aspx',null,null,$post,true,'cookies',"Mozilla/5.0 (Windows; U; Windows NT 5.1; ru; rv:1.9.0.5) Gecko/2008120122 Firefox/3.0.5",1,0,$add_headers);		
