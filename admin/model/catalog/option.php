...
class ModelCatalogOption extends Model {
   ...
   public function addNewoption($data) {
		$this->db->query("INSERT INTO `" . DB_PREFIX . "newoption` SET name = '" . $data['option_description'] . "'");
	}
	
	public function editNewoption($option_id, $data) {
		$this->db->query("UPDATE `" . DB_PREFIX . "newoption` SET name = '" . $this->db->escape($data['option_description']) . "' WHERE newoption_id = '" . (int)$option_id . "'");
		
	}
		
	public function deleteNewoption($option_id) {
		$this->db->query("DELETE FROM `" . DB_PREFIX . "newoption` WHERE newoption_id = '" . (int)$option_id . "'");
	}
	
	public function getNewoptions($data = array()) {
		$sql = "SELECT * FROM `" . DB_PREFIX . "newoption`";
...
public function getTotalNewoptions() {
      	$query = $this->db->query("SELECT COUNT(*) AS total FROM `" . DB_PREFIX . "newoption`"); 
		
		return $query->row['total'];
	}
	
	public function getNewoptionDescriptions($option_id) {

		
		$query = $this->db->query("SELECT name FROM " . DB_PREFIX . "newoption WHERE newoption_id = '" . (int)$option_id . "'");
