        ...
        <table class="form">
          <tr>
            ...
            <tr>
              ...
              <td><?php if (isset($manufacturer) && $manufacturer) { ?>
                <input type="radio" name="manufacturer" value="1" checked="checked" />
                <?php echo $this->language->get('text_yes'); ?>
                <input type="radio" name="manufacturer" value="0" />
                <?php echo $this->language->get('text_no'); ?>
                <?php } else { ?>
                <input type="radio" name="manufacturer" value="1" />
                <?php echo $this->language->get('text_yes'); ?>
                <input type="radio" name="manufacturer" value="0" checked="checked" />
                <?php echo $this->language->get('text_no'); ?>
                <?php } ?></td>
            </tr>
