          ...
          <tbody>
            ...
            <tr>
              <td style="text-align: center;"><?php if ($option['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $option['newoption_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $option['newoption_id']; ?>" />
                <?php } ?></td>
