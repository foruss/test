		...
		<?php } ?>
				...
				<select  name="manufacturer_id">
                  ...
                  <?php } ?>
					...
					<td style="width: 150px;"><b><?php echo $entry_engine; ?></b><br><input type="text" name="engine" value="<?php echo $engine; ?>" /><br><b>Transmission</b><br><select name="product_transmissions">
					<option value="" selected="selected"><?php echo $text_select; ?></option> 
				...
				<td style="width: 150px;">
					...
					<b><?php echo $entry_jan; ?></b><br><input type="text" name="jan" value="<?php echo $jan; ?>" /><br><br>
					<b><?php echo $entry_product_city; ?> </b><input type="text" style="width: 30px;" name="product_city" value="<?php echo $product_city; ?>" />
					<b><?php echo $entry_product_hwy; ?> </b><input type="text" style="width: 32px;" name="product_hwy" value="<?php echo $product_hwy; ?>" /><br>		
            ...
            <tr>
			  ...
			  <td><?php echo $entry_stock_status; ?><br><select name="stock_status_id">
				...
				<td><b><?php echo $entry_youtube; ?> </b><br><input type="text" name="youtube" value="<?php echo $youtube; ?>" /></td>
            </tr>
		 ...
		 <div id="tab-image">
          <table id="images" class="list">
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr>
                <td class="left"><div class="image"><img src="<?php echo $product_image['preview']; ?>" alt="" id="preview<?php echo $image_row; ?>" />
                    <input type="hidden" name="product_image[<?php echo $image_row; ?>][image]" value="<?php echo $product_image['image']; ?>" id="image<?php echo $image_row; ?>" />
                    <br />
                    <a onclick="image_upload('image<?php echo $image_row; ?>', 'preview<?php echo $image_row; ?>');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$('#preview<?php echo $image_row; ?>').attr('src', '<?php echo $no_image; ?>'); $('#image<?php echo $image_row; ?>').attr('value', '');"><?php echo $text_clear; ?></a></div></td>
					<td class="left">
...
function addImages(image_name) {
	...
	var image = 'image';
        html  = '<tbody id="image_row' + image_row + '">';
	html += '<tr>';
	html += '<td class="left"><input type="hidden" name="product_image[' + image_row + '][' + image + ']" value="data/' + image_name +'" id="image' + image_row + '" /><img src="<?php echo $image_path; ?>' + 'cache/data/' + im_thumb + '" alt="" id="preview' + image_row + '" class="image" onclick="image_upload(\'image' + image_row + '\', \'preview' + image_row + '\');" /></td>';
	...
	$.ajax({
		...
		success: function(json) {
			...
			if (json != '') {
				...
				html += '<option selected="selected"><?php echo $text_none; ?></option>';
			}
