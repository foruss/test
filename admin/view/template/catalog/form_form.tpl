                ...
                <div>
                    <table class="form">
						...
						<tr>
                          ...
                          <td><input type="text" name="items[<?php echo $items_row;?>][style]" value="<?php echo $item['style']; ?>" size="100" /></td>
                        </tr>
...
$('#item-add img').live('click', function() {
    ...
    if(item_label.length != 0) {
        ...
        html += '<td><input type="text" name="items['+items_row+'][style]" value="" size="100" /></td>';
        html += '</tr>';
        html += '<tr>';
