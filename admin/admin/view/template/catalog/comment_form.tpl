...
<?php   if (isset($fields) && count($fields)>0) { foreach   ($fields as $af_name => $af_value) { ?>
		 <tr>
            <td><?php echo $af_value['title']; ?></td>
            <td>
             <textarea name="af[<?php echo $af_name; ?>]" cols="40" rows="1"><?php if (isset($af[$af_name])) echo $af[$af_name];  ?></textarea>
            </td>
          </tr>
<?php  }  } ?>
