...
<a class="button fastordermark" href="#" style="margin-bottom: 10px;" onclick="<?php echo $prefix;?>tel(); return false;" ><span class="test"><?php echo $heading_title; ?></span></a>
</div>
...
<div id="form_h1" style="width: 100%; border-bottom: 2px solid #848A8F; font-size: 24px; color:#848A8F;  margin-bottom: 10px;  ">
<?php echo $heading_title; ?>
</div>
<div style="float: left; width: 30%;">
<div id="form_image"></div>

<div id="form_price" style="text-align: center; font-size: 21px;"></div>
...
<div id="form_h1" style="width: 95%; font-size: 24px; color:#848A8F;  margin-bottom: 10px;  margin-left: 25px;">
...
<td>
	<b><ins class="color_entry_name"><?php echo html_entity_decode($field['field_description'][$this->config->get('config_language_id')], ENT_QUOTES, 'UTF-8');  ?></ins></b><br>
	<input type="text" class="datetime-form" placeholder="Date" name="af[<?php echo $field['field_name']; ?>]" size="20" >
</td>
...
<td>
	<b><ins class="color_entry_name"><?php echo html_entity_decode($field['field_description'][$this->config->get('config_language_id')], ENT_QUOTES, 'UTF-8');  ?></ins></b><br>
	<select  name="af[<?php echo $field['field_name']; ?>]">
<option>10 am</option>
<option>11 am</option>
<option>12 am</option>
<option>1 pm</option>
...
?>
  ...
  <div class="bordernone overflowhidden margintop5 lineheight1"></div>
    ...
    if (typeof h1_tovar=='undefined') {
     var h1_tovar = $('.product-info h1').text();
     $('#form_h1').append(' '+h1_tovar);
     $('#hidden_form').val(h1_tovar);


     }

    if (typeof image_tovar=='undefined') {
     var image_tovar = $('.image').html();
     $('#form_image').append(image_tovar);
     $('#form_image #image').css('width','100%');
     }

     if (typeof price_tovar=='undefined') {
     var price_tovar = $('.price').text();
     $('#form_price').append(price_tovar);
     }
