...
<a class="button fastordermark" href="#" style="" onclick="<?php echo $prefix;?>tel(); return false;" ><span class="ask"><?php echo $heading_title; ?></span></a>
</div>
...
<tr>
	<td style="width: 50%;">
	<b><ins class="color_entry_name">*<?php echo html_entity_decode($field['field_description'][$this->config->get('config_language_id')], ENT_QUOTES, 'UTF-8');  ?></ins></b><br>
	<input type="text" name="af[<?php echo $field['field_name']; ?>]" style="width: 45%;">
    </td>
</tr>
<?php } ?>
